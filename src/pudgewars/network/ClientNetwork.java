...
public class ClientNetwork extends Network {
	...
	public void getEntityData() {
		...
		while (!(msg = clientConn.getMessage()).equals("EOM")) {
			...
			if (t[1].equals("PUDGE")) {
				int pudgeIndex = Game.entities.getIndexByClientID(Game.entities.entities, Integer.parseInt(t[2]), PudgeEntity.class);
				...
				int cowIndex = Game.entities.getIndexByClientID(Game.entities.entities, Integer.parseInt(t[2]), CowEntity.class);
